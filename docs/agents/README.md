...
| `Fellow_Astrophysicist` ("Astrophysicist") | Reviews scientific content (physics/astronomy, biology/astrobiology, and adjacent hard sciences) for accuracy, on request (NebulaCast, Visualization Studio, Stellar Attractor) | [fellow-astrophysicist.md](./fellow-astrophysicist.md) | *(not yet built)* | Proposed |
