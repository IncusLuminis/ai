...
| `Studio_Visualizer` ("Visualizer") | Builds Python/Jupyter notebooks for Visualization Studio and Stellar Attractor - static analytical work (stats, charts, real Virtual Observatory data) and animations (scientific or HUD) rendering to webm/gif/mp4 - grounded via WebSearch/VO queries/domain-consultant checks, not sandboxed | [studio-visualizer.md](./studio-visualizer.md) | `.claude/agents/studio-visualizer.md` | Built |
